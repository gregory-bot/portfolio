...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('contact-form').addEventListener('submit', function(e) {
        ...
        const scriptURL = 'https://script.google.com/macros/s/AKfycbxOg2vN2eylNPaWR_30Cs4Kmh1olUiCUXj7QlayB5zRq29Wrcz9Amsu35lLYFwWo_GXPg/exec';  // Replace with your Google Apps Script URL
